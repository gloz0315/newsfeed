...
public class MemberServiceImpl implements MemberService {
  ...
  @Override
  public MemberChangeDto updateMemberName(Member member, MemberUpdateRequestDto dto) {
    Member changeMember = memberRepository.updateMember(member.getId(), MemberUpdateDto.of(dto));
    return MemberChangeDto.of(member.getNickname(), changeMember.getNickname());
  }
}
